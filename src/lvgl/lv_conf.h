...
#define LV_MEM_CUSTOM      01               /*1: use custom malloc/free, 0: use the built-in lv_mem_alloc/lv_mem_free*/
#if LV_MEM_CUSTOM == 0
...
#define LV_VDB_SIZE         (24 * LV_HOR_RES)  /*Size of VDB in pixel count (1/10 screen size is good for first)*/
