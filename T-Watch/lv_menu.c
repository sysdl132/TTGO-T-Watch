...
static const void *motion_img_src[4] = {
  &img_direction_up,
  &img_direction_down,
  &img_direction_left,
  &img_direction_right,
...
unsigned char lv_soil_btn_cb(lv_obj_t *obj)
{
#ifdef ESP32
  soil_led_control();
#endif
...
static void lv_setWinBtnInvaild(bool en)
{
  lv_win_ext_t *ext = (lv_win_ext_t*)lv_obj_get_ext_attr(g_menu_win);
  lv_obj_t *obj = NULL;
...
void charging_anim_callback(void *a)
{
  static const void *src_img[] = {
    &img_batt1,
    &img_batt2,
    &img_batt3,
    &img_batt4
...
{
  static int index = 0;
  lv_kb_ext_t *ext =  (lv_kb_ext_t*)lv_obj_get_ext_attr(passkeyboard);
...
void create_menu(lv_obj_t *par)
{
  ...
  lv_img_set_src(wp, &img_desktop3);
  ...
  ext1 = (lv_win_ext_t*)lv_obj_get_ext_attr(g_menu_win);
...
#define BLE_EN   0
  ...
  lv_tileview_ext_t *ext =  (lv_tileview_ext_t*)lv_obj_get_ext_attr(g_tileview);
  ext->anim_time = 50;
